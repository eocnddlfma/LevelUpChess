...
{
    /// <summary>
    /// 앞 방향으로 두 칸 돌진하는 업그레이드 가능한 무브먼트 (이동 전용)
    /// </summary>
    [CreateAssetMenu(fileName = "MovementDashSO", menuName = "Chess/Piece Movement/Upgradable/Dash Move")]
    public class MovementDashSO : PieceMovementSO
    {
