...
{
    /// <summary>
    /// Bishop용 Knight처럼 이동하는 업그레이드 가능한 무브먼트 (이동 전용)
    /// </summary>
    [CreateAssetMenu(fileName = "MovementBishopKnightMoveSO", menuName = "Chess/Piece Movement/Upgradable/Bishop Knight Move")]
