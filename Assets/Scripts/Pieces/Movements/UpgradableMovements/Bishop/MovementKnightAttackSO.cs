...
{
    /// <summary>
    /// Bishop용 Knight처럼 공격하는 업그레이드 가능한 무브먼트 (공격 전용)
    /// </summary>
    [CreateAssetMenu(fileName = "MovementBishopKnightAttackSO", menuName = "Chess/Piece Movement/Upgradable/Bishop Knight Attack")]
    public class MovementBishopKnightAttackSO : PieceMovementSO
    {
